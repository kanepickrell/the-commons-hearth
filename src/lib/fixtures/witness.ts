...
//
// Fruit counts and units have been lifted into structured data from the
// prose so the Year Wheel can render them. The prose still mentions the
// number — both should stay in sync when edited.
...
export const witnessPosts: WitnessPost[] = [
  {
    ...
    fruit: {
      count: 32,
      unit: { en: 'jars of jelly', es: 'frascos de jalea' },
    },
    replicated: {
      fromMemberId: 'm-003', // Clare taught canning
      toMemberId:   'm-005', // Rebecca now hosting
      skill: { en: 'canning', es: 'enlatado' },
      learnedAtPostId: 'wt-000-seed',
    },
  },
  {
    id: 'wt-002',
    ...
    fruit: {
      count: 2,
      unit: { en: 'chicken coops', es: 'gallineros' },
    },
  },
  {
    id: 'wt-003',
    ...
    fruit: {
      count: 3,
      unit: { en: 'families taught', es: 'familias aprendieron' },
    },
  },
  {
    id: 'wt-004',
    ...
    fruit: {
      count: 6,
      unit: { en: 'menders', es: 'remendadores' },
    },
  },
  {
    id: 'wt-005',
    ...
    fruit: {
      count: 60,
      unit: { en: 'lbs of honey', es: 'libras de miel' },
    },
  },
  {
    id: 'wt-006',
